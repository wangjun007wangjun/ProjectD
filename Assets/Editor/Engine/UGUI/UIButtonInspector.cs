...
public class UIButtonInspector : Editor
{
    ...
    //自动Action
    private SerializedProperty _autoActionProperty;
    ...
    public override void OnInspectorGUI()
    {
        ...
        //自动动作
        EditorGUILayout.PropertyField(_autoActionProperty, new GUIContent("自动触发Action"));
    ...
    protected void OnEnable()
    {
        ...
        _autoActionProperty = serializedObject.FindProperty("IsAutoClickAction");
    }
