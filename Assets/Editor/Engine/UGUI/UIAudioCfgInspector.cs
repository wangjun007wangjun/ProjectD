...
[CustomEditor(typeof(Engine.UGUI.UIAudioCfg))]
public class UIAudioCfgInspector : Editor
{
    ...
    private void DrawData(SerializedProperty data)
    {
        ...
        EditorGUILayout.BeginHorizontal();
        {
            ...
            {
                UnityEngine.Object o = AssetDatabase.LoadMainAssetAtPath("Assets/Resources/" + p.stringValue + ".mp3");
                if (o)
                {
