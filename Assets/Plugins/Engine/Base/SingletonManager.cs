...
namespace Engine.Base
{
    ...
    {
        private static readonly ArrayList<Singleton> Singletons = new ArrayList<Singleton>();

        private static GameObject _monoSingletonGo;
        private static readonly ArrayList<MonoSingleton> MonoSingletons = new ArrayList<MonoSingleton>();
